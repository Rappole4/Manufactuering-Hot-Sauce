...
class SaucesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sauce" do
    assert_difference('Sauce.count') do
      post sauces_url, params: { sauce: { description: @sauce.description, ingredients: @sauce.ingredients, name: @sauce.name, origin: @sauce.origin } }
    end
  ...
  test "should update sauce" do
    patch sauce_url(@sauce), params: { sauce: { description: @sauce.description, ingredients: @sauce.ingredients, name: @sauce.name, origin: @sauce.origin } }
